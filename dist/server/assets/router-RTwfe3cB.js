...
const appCss = "/assets/styles-ln-sB5ak.css";
...
const $$splitComponentImporter = () => import("./index-jgnvPuZ6.js");
const searchSchema = objectType({
  name: fallback(stringType(), "").default("")
});
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "You're invited to celebrate the wedding of Bevin Binny & Jaimi Benny. RSVP now!"
    }, {
      property: "og:title",
      content: "Wedding Invitation — Bevin & Jaimi"
    }, {
      property: "og:description",
      content: "You're invited to celebrate our special day. RSVP now!"
    }]
  })
});
